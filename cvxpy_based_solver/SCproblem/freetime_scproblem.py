...
class FreeTimeSCProblem(SCProblem):
    """
    ...
    def set_problem(self):
        ...
        # Model:
        constraints += self.m.get_constraints(self.var['X'], self.var['U'], self.par['X_last'], self.par['U_last'])
        ...
        # Objective:
        model_objective = self.m.get_objective(self.var['X'], self.var['U'], self.par['X_last'], self.par['U_last'])
